...
class Whitebeet():
    ...
    def v2gSetDCChargingParameters(self, parameter):
        ...
        if not ({"min_current", "min_voltage", "min_power", "min_voltage", "min_current", "min_power", "status", "energy_request", "departure_time", "max_voltage", "max_current", "max_power", "soc", "target_voltage", "target_current", "full_soc", "bulk_soc"} <= set(parameter)):
            ...
            print("min_voltage = ", parameter["min_voltage"])
            print("min_current = ", parameter["min_current"])
            print("min_power = ", parameter["min_power"])
            print("max_voltage = ", parameter["max_voltage"])
            print("max_current = ", parameter["max_current"])
            print("max_power = ", parameter["max_power"])
            print("target_voltage = ", parameter["target_voltage"])
            print("target_current = ", parameter["target_current"])
            print("full_soc = ", parameter["full_soc"])
            print("bulk_soc = ", parameter["bulk_soc"])
            print("energy_request = ", parameter["energy_request"])
            print("departure_time = ", parameter["departure_time"])
